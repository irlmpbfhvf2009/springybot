...
public enum SpringyBotEnum {
    ...
    EDIT_JOBSEARCH("发布求职"),
    UNPUBLISHEDRECRUITMENT("未发布招聘"),
    UNPUBLISHEDJOBSEARCH("未发布求职"),
    JOBPOSTING("jobPosting"),
    JOBSEEKER("jobSeeker"),
    EDITJOBPOSTING("editJobPosting_"),
    EDITJOBSEEKER("editJobSeeker_"),
    REMINDEDITOR("提醒：请复制上列信息到输入框并进行编辑，编辑完毕发送"),
    REMINDEDITOR_("提醒：复制模板到输入框编辑发送，一个账号只能发布一次。可以删除重新发布显示最新时间，或是使用新的账号发布"),
    ...
    JOBPOSTINGDEFAULTFORM("招聘人才\n\n公司：\n职位：\n底薪：\n提成：\n国籍：\n男女：\n人数：\n语言要求：\n是否中介：\n上班时间：\n要求内容：（限50字以内）\n🐌地址：\n✈️咨询飞机号：\n\n关注 @rc499 点击 @rc899Bot 发布"),
    JOBPOSTINGEDITORDEFAULTFORM("编辑招聘\n\n公司：\n职位：\n底薪：\n提成：\n国籍：\n男女：\n人数：\n语言要求：\n是否中介：\n上班时间：\n要求内容：\n🐌地址：\n✈️咨询飞机号：\n\n关注 @rc499 点击 @rc899Bot 发布"),
    JOBSEEKEREDITORDEFAULTFORM("编辑求职\n\n姓名：\n男女：\n人数：\n出生_年_月_日：\n年龄：\n国籍：\n学历：\n技能：\n目标职位：\n手上有什么资源：\n期望薪资：\n工作地址：\n精通语言：\n工作经历：\n自我介绍：\n✈️咨询飞机号：\n\n 关注 @rc499 点击 @rc899Bot 发布"),
    FIFTYCHARACTERSLIMIT("（限50字以内）"),
    REMINDWORKEXPERIENCELIMIT("发送失败,工作经历超过50字"),
    REMINDSELFINTRODUCTIONLIMIT("发送失败,自我介绍超过50字"),
    REMINDREQUIREMENTSLIMIT("发送失败,要求内容超过50字"),
    FILTERKEY("过滤键值 "),
