package com.lwdevelop.bot.talent.handler.commands;
        ...
        if (!StringUtils.hasText(isSuccess)) {
            ...
            while (iterator_channel.hasNext()) {
                ...
                if (!result.isEmpty()) {
                    ...
                    response.setText(SpringyBotEnum.send_recruitment_text(result));
                    ...
                    if (isEdit) {
                        ...
                        editMessageText.setText(SpringyBotEnum.send_recruitment_text(result));
